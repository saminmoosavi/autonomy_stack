...
# Patch deprecated numpy types for ROS packages
...
class VoxelMapper:
    ...
    def cb_odom(self, data):
        ...
        print("got odom"+ str(self.odom_data) + "\n")
    def cb_lidar(self, data):
        ...
        # print("lidar_frame: " + str(lidar_frame) + ", odom_frame: " + str(self.odom_frame) + ", trans: " + str(trans) + "\n")
